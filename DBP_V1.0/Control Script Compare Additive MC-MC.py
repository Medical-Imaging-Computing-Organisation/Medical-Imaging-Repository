...
ETFile01 = 'CSV1_Full_Exact_D1.csv'
ETFile11 = 'CSV1_Full_Exact_D2.csv'
ETFile21 = 'CSV1_Full_Exact_D3.csv'
ETFile31 = 'CSV1_Full_Exact_D4.csv'
ETFile41 = 'CSV1_Full_Exact_D5.csv'
ETFile51 = 'CSV1_Full_Exact_D6.csv'
ETFile61 = 'CSV1_Full_Exact_D7.csv'
ETFile71 = 'CSV1_Full_Exact_D8.csv'
Det_Pos1 = 'CSV 2 setup 10.2.csv'

ETFile02 = 'CSV1_Full_Smeared_D1.csv'
ETFile12 = 'CSV1_Full_Smeared_D2.csv'
ETFile22 = 'CSV1_Full_Smeared_D3.csv'
ETFile32 = 'CSV1_Full_Smeared_D4.csv'
ETFile42 = 'CSV1_Full_Smeared_D5.csv'
ETFile52 = 'CSV1_Full_Smeared_D6.csv'
ETFile62 = 'CSV1_Full_Smeared_D7.csv'
ETFile72 = 'CSV1_Full_Smeared_D8.csv'
Det_Pos2 = 'CSV 2 setup 10.2.csv'
...
eventsbar = ax[7].bar(['Exact', 'Smeared'], [np.mean(hits1), np.mean(hits2)], color=['tab:red', 'tab:blue'])
ax[7].errorbar(['Exact', 'Smeared'], [np.mean(hits1), np.mean(hits2)],
...
print("Exact Coincidences/Events", fCo1.shape[0]/Scatters1, fCo1.shape[0]/Absorbs1)
...
print("Smeared Coincidences/Events", fCo2.shape[0]/Scatters2, fCo2.shape[0]/Absorbs2)


scat_efficiency_smeared = 0.0027*100
abs_efficiency_smeared = 0.0002*100
scat_efficiency_exact = 0.0026*100
abs_efficiency_exact = 0.0003*100


bar1 = ax[9].bar([0, 3], [scat_efficiency_exact, abs_efficiency_exact], color='tab:red', label='Exact')
bar2 = ax[9].bar([1, 4], [scat_efficiency_smeared, abs_efficiency_smeared], color='tab:blue', label='Smeared')
...
ax[9].bar_label(bar1, fmt='{:,.2f}', fontsize=8)
ax[9].bar_label(bar2, fmt='{:,.2f}', fontsize=8)
...
ax[9].set_title('IR Efficiency / %', fontsize=9, pad=0.1)
plt.show()
