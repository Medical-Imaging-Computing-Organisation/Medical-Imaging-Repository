...
# additive constant
# additive_constant = 11 # change as needed
# for i in range(0, data.shape[0]):
...
# np.transpose(data, axes=[0, 3, 1, 2, 4, ])

np.random.shuffle(data)
added_data[0] = data[0]
for i in range(1,int(data.shape[0]/4)):
    added_data[0] += data[i]

added_data[1] = data[int(data.shape[0]/4)]
for i in range(int(data.shape[0]/4)+1,int(data.shape[0]/2)):
    added_data[1] += data[i]

added_data[2] = data[int(data.shape[0]/2)]
for i in range(int(data.shape[0]/2)+1,int(3*data.shape[0]/4)):
    added_data[2] += data[i]

added_data[3] = data[int(3*data.shape[0]/4)]
for i in range(int(3*data.shape[0]/4)+1,int(data.shape[0])):
    added_data[3] += data[i]
